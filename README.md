...
The keycodes used in this program are from the [standard Linux keymap](https://github.com/torvalds/linux/blob/master/include/uapi/linux/input-event-codes.h).
